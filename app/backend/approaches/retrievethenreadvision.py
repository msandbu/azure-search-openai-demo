...
class RetrieveThenReadVisionApproach(Approach):
    ...
    system_chat_template_gpt4v = (
        "You are an intelligent assistant helping provide assistance to better help protect against ransomware attacks, The documents contain text, graphs, tables and images. "
